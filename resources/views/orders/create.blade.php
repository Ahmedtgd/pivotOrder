...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const product2Select = document.querySelector('[name="Product2_id"]');
    const product2Quantity = document.getElementById('Product2_quantity');

    toggleProductButton.addEventListener('click', function() {
        if (!showProduct2) {
            productFields2.style.display = 'block';
            toggleProductButton.textContent = 'Delete Product';
            showProduct2 = true;
        } else {
            ...
            // Clear selected value and quantity for Product 2
            product2Select.selectedIndex = 0;
